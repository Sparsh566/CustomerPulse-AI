...
import { FileBarChart, Clock, ShieldCheck, TrendingUp, Brain, Bot, BarChart3 } from 'lucide-react';
...
export default function AnalyticsPage() {
  ...
  return (
    <AppShell title="Analytics & AI Insights">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <Tabs defaultValue="insights" className="w-full">
        <TabsList className="mb-6">
          <TabsTrigger value="insights" className="gap-1.5"><Brain className="w-4 h-4" />AI Insights</TabsTrigger>
          <TabsTrigger value="assistant" className="gap-1.5"><Bot className="w-4 h-4" />AI Assistant</TabsTrigger>
          <TabsTrigger value="charts" className="gap-1.5"><BarChart3 className="w-4 h-4" />Charts</TabsTrigger>
        </TabsList>
